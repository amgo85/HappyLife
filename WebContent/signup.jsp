...
<body>
	<form action="${pageContext.request.contextPath}/signup" method="post" commandName="user" class="form-signup" style="box-shadow: 0 0 black;">
		    
			<div class="col-md-12 col-md-push-3">
				<div class="text-center mb-4">
		    		<h1 class="h3 mb-3 font-weight-normal">Sign up or <a class="demo" href="./login.html">Login Here</a> </h1>
		    		<br>
		    	...
		    	<div class="row">
		    		<div class="form-group col-md-6">
	       				<input type="text" name="fname" id="inputFirstName" value="<%=request.getParameter("fname")%>" class="form-control" placeholder="First Name" required="" autofocus="">
		    		</div>
		    		
		    		<div class="form-group col-md-6">
	       				<input type="text" name="lname" id="inputLastName" value="<%=request.getParameter("lname")%>" class="form-control" placeholder="Last Name" required="" autofocus="">
		    		</div>
	     		</div>
				
	      		<div class="row">
	      			<div class="form-group col-md-12">
	        			<input type="email" name="email" id="inputEmail" value="<%=request.getParameter("email") %>" class="form-control" placeholder="Email address" required="" autofocus="">
	      			</div>
	      		</div>
