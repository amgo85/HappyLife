...
<body>
	...
	<div class="container">
		<ul class="nav nav-tabs">
			<li><a href="/HappyLife/admin_profile">All Messages</a></li>
			<li class="active"><a href="/HappyLife/admin_approved">Approved</a></li>
			...
			<div id="home" class="tab-pane fade in active">
				...
				<div id="myIdeal" class="grid-container">
					...
					<table class="table table-dark">
						...
						<%
						  	List<Messages> approvedMessagesList = (List<Messages>)request.getAttribute("approvedMessagesList");
							List<User> approvedMessageSendersList = (List<User>)request.getAttribute("approvedMessageSendersList");
							...
							int i = 0;
							System.out.println("usersList list =" + approvedMessageSendersList.size());
					  		System.out.println("Messages list =" + approvedMessagesList.size());
						  	for(Messages m: approvedMessagesList){
						  		User pu = approvedMessageSendersList.get(i++);
						 %>
						 	<tbody>
							    <tr>
							    	<th scope="row"><%=i%></th>
