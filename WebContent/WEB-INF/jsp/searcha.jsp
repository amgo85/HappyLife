<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.happylife.pojo.User, java.util.*, com.happylife.DoMath"%>
...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs navbar-right">
			...
			<li class="active"><a href="/HappyLife/search">البحث</a></li>
		...
		<div class="tab-content ">
			<div id="menu2" class="tab-pane fade in active">
				...
				<div class="row">
					...
					<br>
					<br>
					<div class="column navbar-right" style="background-color:#33b5e5;">
						<ul>
	    					<li id="idmatch" >الشريك المثالي <input type="checkbox" id="idealcb" name="select" value="idealcb"></li>
	    					
	    					<li id="lookingFor">من أبحث عنهم <input type="checkbox" id="" name="lfselect" value="ilookfcb"></li>
	    					<li id="lookingForMe">من يبحثون عني <input type="checkbox" id="" name="lfmselect" value="lookformecb"></li>
	    					<li id="onlineNow">متصل الآن <input type="checkbox" id="" name="select" value="online"></li>
	    					<li id="photosUploaded">أرني الحسابات التي تم تحميل صور شخصية معها<input type="checkbox" id="" name="select" value="photoupl"></li>
	    					<li id="hvntviewed">فقط الذين لم أطلع على حساباتهم <input type="checkbox" id="" name="select" value="notviewed"></li>
	    					<li id="hvntmessgd">فقط الذين لم أراسلهم <input type="checkbox" id="" name="select" value="notmsged"></li>
	    					<li id="age-select"><div class="">العمر من
				  			...
				  			%>
				  				<tbody>
				  					<tr>
			    						...
			    						<td class="text-right"><br><a href="${pageContext.request.contextPath}/sendmessageto?=<%=u.getUserId()%>">أرسل رسالة</a><br>
			    							<a>إضافة الحساب إلى مفضلاتي</a><br>
			    							<a>طلب تبادل صور</a><br>
			    							<a>دعوة للاطلاع على حسابي</a><br>
			    							<a>ملاحظاتي على الحساب</a><br>
